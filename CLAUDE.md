...
3. `skills/comfyui-workflow-builder/specs/COMFYUI_FORMAT.md` and `skills/comfyui-workflow-builder/specs/NODE_CATALOG.md` for schema, slot order, and widget order.
